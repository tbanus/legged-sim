 ...
 public:
  ...
  RobotControlParameters()
      : ControlParameters("robot-parameters"),
        ...
        INIT_PARAMETER(desired_height),
        INIT_PARAMETER(abad_limits),
        INIT_PARAMETER(hip_limits),
        INIT_PARAMETER(knee_limits),
  ...
  DECLARE_PARAMETER(float, desired_height)
  ...
  DECLARE_PARAMETER(Vec3<double>, abad_limits)
  DECLARE_PARAMETER(Vec3<double>, hip_limits)
  DECLARE_PARAMETER(Vec3<double>, knee_limits)
  // state estimator
