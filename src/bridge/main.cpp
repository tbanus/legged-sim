...
int main(int argc, char* argv[]){
  ...
  // if (! &_CANcommand){LOG(FATAL)<<"Cannot initalize _CANcommand";}

  // CANData _CANData;
  // if (! &_CANData){LOG(FATAL)<<"Cannot initalize _CANData";}

  // GamepadCommand _GamepadCommand;
  // if (! &_GamepadCommand){LOG(FATAL)<<"Cannot initalize _GamepadCommand";}

  // IMUData _vectorNavData;
  // if (! &_vectorNavData){LOG(FATAL)<<"Cannot initalize _vectorNavData";}
  ...
  //   InitializeSLCs(&_CANData,&_CANcommand,&taskManager);
  // #endif
  ...
  // _robotRunner->_CANData = &_CANData;
  // _robotRunner->_CANcommand = &_CANcommand;
