...
#ifndef __can_command_lcmt_hpp__
#define __can_command_lcmt_hpp__

#include <lcm/lcm_coretypes.h>



class can_command_lcmt
{
    public:
        float      q_des_abad[4];
...
int can_command_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int can_command_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int can_command_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t can_command_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* can_command_lcmt::getTypeName()
{
    return "can_command_lcmt";
}

int can_command_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int can_command_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int can_command_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t can_command_lcmt::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xddd4852f631133afLL;
