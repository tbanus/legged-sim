...
#ifndef __can_data_lcmt_hpp__
#define __can_data_lcmt_hpp__
...
int can_data_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int can_data_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int can_data_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t can_data_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* can_data_lcmt::getTypeName()
{
    return "can_data_lcmt";
}

int can_data_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int can_data_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int can_data_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t can_data_lcmt::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xc51e25da55f0463dLL;
