...
class wbc_data_lcmt(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(wbc_data_lcmt._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != wbc_data_lcmt._get_packed_fingerprint():
            raise ValueError("Decode error")
        return wbc_data_lcmt._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if wbc_data_lcmt in parents: return 0
    ...
    def _get_packed_fingerprint():
        if wbc_data_lcmt._packed_fingerprint is None:
            wbc_data_lcmt._packed_fingerprint = struct.pack(">Q", wbc_data_lcmt._get_hash_recursive([]))
        return wbc_data_lcmt._packed_fingerprint
    _get_packed_fingerprint = staticmethod(_get_packed_fingerprint)

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", wbc_data_lcmt._get_packed_fingerprint())[0]
