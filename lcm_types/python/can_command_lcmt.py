...
class can_command_lcmt(object):
    __slots__ = ["q_des_abad", "q_des_hip", "q_des_knee", "qd_des_abad", "qd_des_hip", "qd_des_knee", "kp_abad", "kp_hip", "kp_knee", "kd_abad", "kd_hip", "kd_knee", "tau_abad_ff", "tau_hip_ff", "tau_knee_ff", "time"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [[4], [4], [4], [4], [4], [4], [4], [4], [4], [4], [4], [4], [4], [4], [4], None]
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(can_command_lcmt._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != can_command_lcmt._get_packed_fingerprint():
            raise ValueError("Decode error")
        return can_command_lcmt._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = can_command_lcmt()
    ...
    def _get_hash_recursive(parents):
        if can_command_lcmt in parents: return 0
        tmphash = (0xddd4852f631133af) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if can_command_lcmt._packed_fingerprint is None:
            can_command_lcmt._packed_fingerprint = struct.pack(">Q", can_command_lcmt._get_hash_recursive([]))
        return can_command_lcmt._packed_fingerprint
    _get_packed_fingerprint = staticmethod(_get_packed_fingerprint)

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", can_command_lcmt._get_packed_fingerprint())[0]
